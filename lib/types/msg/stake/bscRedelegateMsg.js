...
var BscReDelegateMsg = /* #__PURE__ */(function (_BaseMsg) {
  ...
  function BscReDelegateMsg (_ref) {
    ...
    var validator_src_addr = _ref.validator_src_addr
    var validator_dst_addr = _ref.validator_dst_addr
  ...
  (0, _createClass2.default)(BscReDelegateMsg, [{
    ...
    value: function getSignMsg () {
      ...
      var denom = _this$amount.denom
      var amount = _this$amount.amount
      var signMsg = {
